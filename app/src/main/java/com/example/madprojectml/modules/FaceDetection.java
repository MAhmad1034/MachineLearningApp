...
import com.example.madprojectml.mlmodels.FaceDetectionModel;
...
public class FaceDetection extends AppCompatActivity {
    ...
    private void openImageSelectionForm() {
        Intent intent = new Intent(this, FaceDetectionModel.class);
    ...
    private void loadImagesFromFirebase() {
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(FaceDetection.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
